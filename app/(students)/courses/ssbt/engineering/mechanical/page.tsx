...
const academicYears = [
  {
    ...
    tag: 'Foundation',
    color: 'bg-yellow-50',
    link: '/courses/ssbt/engineering/mechanical/fy'
  ...
  },
  {
    ...
    tag: 'Core',
    color: 'bg-blue-50',
    link: '/courses/ssbt/engineering/mechanical/sy'
  },
  {
    id: 'year-3',
    title: '3rd Year',
    ...
    tag: 'Advanced',
    color: 'bg-purple-50',
    link: '/courses/ssbt/engineering/mechanical/ty'
  },
  {
    id: 'year-4',
    title: '4th Year',
    ...
    tag: 'Professional',
    color: 'bg-emerald-50',
    link: '/courses/ssbt/engineering/mechanical/ly'
  }
];
