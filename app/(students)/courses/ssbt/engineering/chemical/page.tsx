...
const academicYears = [
  {
    ...
    tag: 'Foundation',
    color: 'bg-yellow-50',
    link: '/courses/ssbt/engineering/chemical/fy'
  ...
  },
  {
    ...
    tag: 'Core',
    color: 'bg-blue-50',
    link: '/courses/ssbt/engineering/chemical/sy'
  },
  {
    id: 'year-3',
    title: '3rd Year',
    ...
    tag: 'Advanced',
    color: 'bg-purple-50',
    link: '/courses/ssbt/engineering/chemical/ty'
  },
  {
    id: 'year-4',
    title: '4th Year',
    ...
    tag: 'Professional',
    color: 'bg-emerald-50',
    link: '/courses/ssbt/engineering/chemical/ly'
  }
];
