...
const course: Course = {
  ...
  subtitle: "Nature-Inspired Algorithms and Fuzzy Logic",
  semester: "Semester VIII",
  category: "Computer Engineering",
  description: "A study of techniques that provide robust and low-cost solutions to complex problems. Includes Fuzzy Logic, Artificial Neural Networks (ANN), Genetic Algorithms (GA), and Hybrid Systems like Neuro-Fuzzy modeling.",
  lastUpdated: "May 2026",
};

const teacher: Teacher = {
  name: "Dr. Vidya A. Patil",
  department: "Dept. of Computer Engineering",
  email: "vidya.patil@ssbt.ac.in",
  avatar: "",
};
...
const units: Unit[] = [
  { 
    id: 1, 
    title: "Unit 1 — Introduction to Soft Computing", 
    notesPath: "/courses/computer/ly/sem2/sc/sc_unit1.pdf", 
    pyqPath: "/pyq/sc/unit1-pyq.pdf", 
    videoUrl: "https://youtube.com/playlist?list=sc-u1" 
  },
  { 
    id: 2, 
    title: "Unit 2 — Fuzzy Logic & Fuzzy Systems", 
    notesPath: "/courses/computer/ly/sem2/sc/sc_unit2.pdf", 
    pyqPath: "/pyq/sc/unit2-pyq.pdf", 
    videoUrl: "https://youtube.com/playlist?list=sc-u2" 
  },
  { 
    id: 3, 
    title: "Unit 3 — Artificial Neural Networks (ANN)", 
    notesPath: "/courses/computer/ly/sem2/sc/sc_unit3.pdf", 
    pyqPath: "/pyq/sc/unit3-pyq.pdf", 
    videoUrl: "https://youtube.com/playlist?list=sc-u3" 
  },
  { 
    id: 4, 
    title: "Unit 4 — Genetic Algorithms (GA)", 
    notesPath: "/courses/computer/ly/sem2/sc/sc_unit4.pdf", 
    pyqPath: "/pyq/sc/unit4-pyq.pdf", 
    videoUrl: "https://youtube.com/playlist?list=sc-u4" 
  },
  { 
    id: 5, 
    title: "Unit 5 — Hybrid Systems & Swarm Intelligence", 
    notesPath: "/courses/computer/ly/sem2/sc/sc_unit5.pdf", 
    pyqPath: "/pyq/sc/unit5-pyq.pdf", 
    videoUrl: "https://youtube.com/playlist?list=sc-u5" 
  },
];
    ...
    <Card className="border-border shadow-sm sticky top-6">
      <CardContent className="p-4 flex flex-col items-center text-center gap-3">
        <Avatar className="h-14 w-14 rounded-xl border-2 border-amber-400/40 mt-1">
          ...
          <AvatarFallback className="rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 text-white text-base font-bold">
            {teacher.name
              .split(" ")
              .slice(-2)
              .map((n) => n[0])
