...
const course: Course = {
  ...
  subtitle: "Numerical Mastery for Placements and GATE",
  semester: "Final Year (Placement Prep)",
  category: "Training & Placement",
  description: "Comprehensive aptitude training focusing on arithmetic, algebra, number systems, and data interpretation hacks.",
  lastUpdated: "March 2026",
};

const teacher: Teacher = {
  name: "Prof. Rahul K. Gupta",
  department: "Dept. of Applied Mathematics",
  email: "rahul.gupta@ssbt.ac.in",
  avatar: "",
};

const units: Unit[] = [
  { id: 1, title: "Unit 1 — Number Systems & HCF/LCM", notesPath: "/courses/computer/ly/sem1/qrps/qrps_unit1.pdf", pyqPath: "/pyq/quant/u1.pdf", videoUrl: "https://youtube.com/playlist?list=q-u1" },
  { id: 2, title: "Unit 2 — Profit, Loss, & Percentages", notesPath: "/courses/computer/ly/sem1/qrps/qrps_unit2.pdf", pyqPath: "/pyq/quant/u2.pdf", videoUrl: "https://youtube.com/playlist?list=q-u2" },
  { id: 3, title: "Unit 3 — Time, Speed, & Distance", notesPath: "/courses/computer/ly/sem1/qrps/qrps_unit3.pdf", pyqPath: "/pyq/quant/u3.pdf", videoUrl: "https://youtube.com/playlist?list=q-u3" },
  { id: 4, title: "Unit 4 — Probability & Combinations", notesPath: "/courses/computer/ly/sem1/qrps/qrps_unit4.pdf", pyqPath: "/pyq/quant/u4.pdf", videoUrl: "https://youtube.com/playlist?list=q-u4" },
  { id: 5, title: "Unit 5 — Data Interpretation & Graphs", notesPath: "/courses/computer/ly/sem1/qrps/qrps_unit5.pdf", pyqPath: "/pyq/quant/u5.pdf", videoUrl: "https://youtube.com/playlist?list=q-u5" },
];
